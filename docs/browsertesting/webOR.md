...
* To view all test cases that reference an Object within the project, use the `Get Impacted TestCases` option. This feature is available for both Project and Shared repositories.
