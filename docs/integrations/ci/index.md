...
[GitHub Actions :simple-githubactions:](githubactions){ .md-button } [Azure DevOps :material-microsoft-azure-devops:](azuredevops.md){ .md-button }  [Circle CI :simple-circleci:](circleci){ .md-button } 
